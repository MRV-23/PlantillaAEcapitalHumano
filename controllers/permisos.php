...
class PermisosControllers{
	...
	public static function vacacionesNuevoControllers($datos){
		...
		if( date($datos['fechaInicial']) <= date('2020-03-16')  &&  date($datos['fechaFinal']) >= date('2020-03-16') )
			$datos['conteo'] += 1;
		/***************************** */
		if( date($datos['fechaInicial']) <= date('2020-05-01')  &&  date($datos['fechaFinal']) >= date('2020-05-01') )
			$datos['conteo'] += 1;
		if( date($datos['fechaInicial']) <= date('2020-09-16')  &&  date($datos['fechaFinal']) >= date('2020-09-16') )
			$datos['conteo'] += 1;
		if( date($datos['fechaInicial']) <= date('2020-11-16')  &&  date($datos['fechaFinal']) >= date('2020-11-16') )
			$datos['conteo'] += 1;
		if( date($datos['fechaInicial']) <= date('2020-12-25')  &&  date($datos['fechaFinal']) >= date('2020-12-25') )
			$datos['conteo'] += 1;
