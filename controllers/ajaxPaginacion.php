...
class Paginacion{
    ...
    public function parametroNombre($valor){
        $this->parametrosOpcionales .= "buscar="."'".$valor."'";
    }

    public function parametrosPaginador($data){//Este es el metodo que se va a utilizar para depurar los anteriores
        foreach($data as $row => $item){
            $this->parametrosOpcionales  .= "$row = '$data[$row]'";
        }
    }
