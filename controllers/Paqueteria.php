...
class Paqueteria{
	...
	public static  function detallePaqueteInterno($usuario,$idPaquete){
		...
		if( ( $_SESSION['identificador2'] == Configuraciones::recepcion() || AccesoEspecialPaqueteria::pertenece($_SESSION['identificador']) ) && $flag && $respuesta['situacion'] != 4 && $respuesta['situacion'] != 2 ){
			$etiqueta='Guia: ';
	...
	public static  function detallePaqueteExterno($idPaquete){
		...
		if( ($_SESSION['identificador2'] == Configuraciones::recepcion() || AccesoEspecialPaqueteria::pertenece($_SESSION['identificador']) ) && $respuesta['situacion'] != 4 && $respuesta['situacion'] != 2){
			...
			if($respuesta['situacion'] == 3){
				...
				$html.='<div class="row">
							...
							<div class="col-md-6 estilos-centrar">
								<button type="button" class="btn btn-danger" id="paqueteCancelarExterno">Cancelar envioo</button>
							</div>
						</div>';
			}
