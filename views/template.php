...
class Cabeceras{
	...
	public function reportes_vacaciones(){
		...
		$hoja->setCellValueByColumnAndRow($columna++,1,"DIAS DISFRUTADOS EN EL AÑO 2019");
		...
		foreach ($respuesta as $row => $item){ 
					...
					$hoja->setCellValueByColumnAndRow($columna++,$fila,Reportes::vacacionesDisponibles($item['id']));
					$columna=1;
					$fila++;
				}  
...
/**********************************************************************************************************************/
		...
		$hoja->setCellValueByColumnAndRow($columna++,$fila,"OBSERVACIONES		");
		$hoja->setCellValueByColumnAndRow($columna++,$fila,"FECHA DE LIBERACIÓN		");
		$hoja->setCellValueByColumnAndRow($columna++,$fila,"FONDEO IMSS		");
		...
		$hoja->getStyle('A3:BV3')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
	...
	public function reporteNominasSucursal(){
		...
		/*$hoja->setCellValue("BI1", "FINANZAS");
		$hoja->mergeCells('BI1:BU1');
		$hoja->getStyle('BI1')->getFont()->setBold(true);
		$hoja->getStyle('BI1')->getAlignment()->setHorizontal(Alignment::HORIZONTAL_CENTER);
		$hoja->getStyle('BI1:BU1')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('D6D577');*/
...
/**********************************************************************************************************************/
		...
		/*$hoja->setCellValue("BI2", "");
		$hoja->mergeCells('BI2:BQ2');
		$hoja->getStyle('BI2:BQ2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('D6D577');
		$hoja->setCellValue("BR2", "CAPTURÓ");
		$hoja->mergeCells('BR2:BU2');
		$hoja->getStyle('BR2:BU2')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('CD6155');*/
		...
		/*$hoja->getStyle('BI3:BQ3')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('D6D577');

		$hoja->getStyle('BR3:BU3')->getFont()->getColor()->setARGB(Color::COLOR_WHITE);
		$hoja->getStyle('BR3:BU3')->getFill()->setFillType(\PhpOffice\PhpSpreadsheet\Style\Fill::FILL_SOLID)->getStartColor()->setARGB('CD6155');*/
...
<html>
  <head>
    ...
    <!--<link rel="stylesheet" href="<?php echo Ruta::ruta_server(); ?>views/css/estilos.min.css">-->
	...
	<link rel="stylesheet" href="<?php echo Ruta::ruta_server(); ?>views/css/estilos.css">
	<link rel="stylesheet" href="<?php echo Ruta::ruta_server(); ?>views/css/test.css">
  ...
  <body class="hold-transition sidebar-mini <?php  echo ' '.$respuesta = isset($_COOKIE['configColorScreen']) ? $_COOKIE['configColorScreen'] : ''; echo ' '.$respuesta = isset($_COOKIE['configSideLeft']) ? $_COOKIE['configSideLeft'] : ''; echo ' '.$respuesta = isset($_COOKIE['configScreenSize']) ? $_COOKIE['configScreenSize'] : '';?>">
	...
	<script src="<?php echo Ruta::ruta_server(); ?>views/js/metodosDiversos.min.js" async="async"></script>
		
    <script src="<?php echo Ruta::ruta_server(); ?>views/js/bootstrap-year-calendar.js"></script>
	...
	<!--<script src="<?php echo Ruta::ruta_server(); ?>views/js/paginador.js"></script>-->
	...
	<script src="<?php echo Ruta::ruta_server(); ?>views/js/slide.min.js"></script>
	...
	<!--<script src="http://192.168.0.10:49000/socket.io/socket.io.js"></script>-->
	<?php if($_SERVER['REQUEST_URI'] === '/asesores/ticket'): ?>
	...
	<?php if($_SERVER['REQUEST_URI'] === '/asesores/tickets-administrador'): ?>
		<script src="<?php echo Ruta::ruta_server(); ?>views/js/tickets-admin-2.js"></script>
	<?php endif;?>
	...
	<script src="<?php echo Ruta::ruta_server(); ?>views/js/reportesRecursosHumanos.min.js" async="async"></script>
	...
	<?php if($_SERVER['REQUEST_URI'] === '/asesores/nominas' || $_SERVER['REQUEST_URI'] === '/asesores/finanzas' || $_SERVER['REQUEST_URI'] === '/asesores/tesoreria' || $_SERVER['REQUEST_URI'] === '/asesores/liberacion'): ?>
		<script src="<?php echo Ruta::ruta_server(); ?>views/js/nominas.js" async="async"></script>
	<?php endif;?>

	<script src="<?php echo Ruta::ruta_server(); ?>views/js/chat.js" async="async"></script>
