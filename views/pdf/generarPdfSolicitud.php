...
if($_SESSION['identificador'] !=168 AND $_SESSION['identificador'] !=171 AND $_SESSION['identificador'] != 172 AND $_SESSION['identificador'] !=215){
...
if($permiso['tipo_solicitud'] == 1){
    ...
    //Estos if son temporales, debemos de crear una tabla donde RH tenga el control de los días inhabiles

   
    if(  date($permiso['fecha_inicio']) <= date('2019-11-18')  &&  date($permiso['fecha_fin']) >= date('2019-11-18') )
        $porDisfrutar -= 1;
    ...
    if(  date($permiso['fecha_inicio']) <= date('2020-05-01')  &&  date($permiso['fecha_fin']) >= date('2020-05-01') )
        $porDisfrutar -= 1;
    if(  date($permiso['fecha_inicio']) <= date('2020-09-16')  &&  date($permiso['fecha_fin']) >= date('2020-09-16') )
        $porDisfrutar -= 1;
    if(  date($permiso['fecha_inicio']) <= date('2020-11-16')  &&  date($permiso['fecha_fin']) >= date('2020-11-16') )
        $porDisfrutar -= 1;
    if(  date($permiso['fecha_inicio']) <= date('2020-12-25')  &&  date($permiso['fecha_fin']) >= date('2020-12-25') )
        $porDisfrutar -= 1;
