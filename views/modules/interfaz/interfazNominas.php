                ...
                <ul class="nav nav-tabs">
                    <?php if($nominas === 'active'):?>
                        <li role="presentation" class="<?php echo $nominas; ?>">
                            <a href="#agregar" aria-controls="nutriologa" role="tab" data-toggle="tab">Capturar</a>
                        </li>
                    <?php endif; ?>
                    
                    <li role="presentation" class="<?php echo $finanzas; ?>">
                        <a href="#consultar" aria-controls="informacion" role="tab" data-toggle="tab">Consultar</a>
                    </li>

                    <li role="presentation">
                        <a href="#importar" aria-controls="nutriologa" role="tab" data-toggle="tab">Cargar-Descargar archivos</a>
                    </li>
                ...
                <div class="tab-content" style="margin-top: 2%;">
                    ...
                    <div role="tabpanel" class="tab-pane <?php echo $nominas; ?>" id="agregar"> 
                        ...
                        <form method="POST" id="formularioNominas">
                            <div style="border:2px dotted gray;">
                                ...
                                <div class="row form-group rowColorGray">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon info" title="Información del campo" info="El porcentaje (monto) que representa la comisión cobrada">
                                ...
                                <div class="row form-group rowColorGray">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control monetario" type="text" id="nominasIva" name="nominasIva">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control monetario" type="text" id="nominasTotal" name="nominasTotal">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group rowColorGray">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control monetario iluminarIconoInput" type="input" name="nominasIsn">
                                        </div>                              
                                    </div>
                                </div>
                            ...
                            <div class="row">
                               ...
                               <p>Total de archivos adjuntos: <b><span id="totalAdjuntos" style="font-size:20px;">0</span></b></p>
                                                    ...
                                                    <div class="col-md-4">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-control textoMay iluminarIconoInput" name="statusNominas" >
                                                                ...
                                                                <option value="2">NO LIBERADA</option>
                                                                <option value="3">LIBERADA / NO LIBERADA</option>
                                                            </select>
                                                        </div>     
                                                    </div>
                                                    <div class="col-md-2">
                    ...
                    <div role="tabpanel" class="tab-pane administrar-nominas <?php echo $finanzas; ?>" id="consultar"> 
                        ...
                        <?php endif;?>
                         ...
                         <?php if($_SESSION['identificador'] == 172 || $nominas === "active" || $_SESSION['identificador'] == 168 ):/*if($nominas === "active"):*/ ?>
                            <div class="row form-group">
                                <div class="col-md-12">
                        ...
                        <div class="row form-group">
                            <div class="col-md-4">
                                <label for="">Monto (iva,subtotal,total,total a depositar):</label>                               
                                <div class="input-group">
                                    <div class="input-group-addon">
                                        <i class="fa fa-dollar"></i>
                                    </div>
                            ...
                            <div class="col-md-4">
                                <label for="">Estatus liberación (Finanzas):</label>
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            <i class="fa fa-list-ol"></i>
                                        </div>
                            ...
                            <div class="col-md-4">
                                <label for="">Estatus Pago (Tesoreria):</label>
                                    <div class="input-group">
                                        <div class="input-group-addon">
                                            <i class="fa fa-list-ol"></i>
                                        </div>
