...
?>
  ...
  <div class="content-wrapper">
    <!-- Main content -->
    <section class="content" id="contenedorPrincipalNominas">
      <!-- Default box -->
      <div class="box">
        ...
        <div class="box-body">
            <div role="tabpanel"> 
                <ul class="nav nav-tabs">
                    ...
                    <?php 
                    $respuesta = ReportesModel::verificarJefatura(Tablas::usuarios());
                    if($finanzas === 'active' AND $liberacion != 'active' AND $respuesta > 2 ):?>
                        <li role="presentation" class="<?php echo $nominas; ?>">
                            <a href="#configurar" aria-controls="agregar" role="tab" data-toggle="tab">Configurar clientes</a>
                        </li>
                    <?php endif; ?>

                    <?php if($_SESSION['identificador2'] == 6 || $_SESSION['identificador'] == 201 || $_SESSION['identificador'] == 204 || $_SESSION['identificador'] == 195 || $_SESSION['identificador'] == 188): ?>
                        ...
                        <form method="POST" id="formularioNominas">
                            <div style="border:2px dotted gray;">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control textoMay iluminarIconoInput asimilados-validacion mixto-validacion sys-validacion tarjeta-validacion sindicato-validacion" name="nominasTipoPago" >
                                                ...
                                                <option value="20">VIÁTICOS</option>
                                                <option value="21">VIÁTICOS ENTREGADOS(AJUSTE)</option>
                                ...
                                <div class="row form-group rowColorWhite">
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon info" title="Información del campo" info="se suman los campos: 25 + 43">
                                                <i class="fa fa-dollar"></i>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon info" title="Información del campo" info="se suman los campos: 53 + 54 + 55 + 56 + 57 + 58 + 61 + 62 + 63 + 64 + 65">
                                                <i class="fa fa-dollar"></i>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon info" title="Información del campo" info="se suman los campos: 59 + 60 + 67">
                                                <i class="fa fa-dollar"></i>
                                            </div>
                            ...
                            <div style="border:2px dotted gray;">
                                ...
                                <div class="row form-group rowColorGray">
                                    ...
                                    <div class="col-md-3">
                                        <label for="">28.-Impuesto estatal: <i class="fa fa-check-circle text-green campoRetencionObligatorio" style="display:none;"></i> <label class="container_"><input type="checkbox" id="checkCalcularIsn"><span class="checkmark_"></span></label></label>
                                        <div class="input-group">
                                 ...
                                 <div class="row form-group rowColorWhite">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control monetario iluminarIconoInput" type="input" name="gastos_medicos2">
                                        </div>                              
                                    </div>
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon info" title="Información del campo" info="Sumatoria de todos los campos de sueldos y salarios (21-47), únicamente de carácter comprobatorio" style="background:#00a65a!important;">
                                            <i class="fa fa-dollar"></i>
                                            </div>
                                            <input class="form-control monetario iluminarIconoInput" type="input" id="comprobacionSys" disabled>
                                        </div>                              
                                    </div>
                            ...
                            <div style="border:2px dotted gray;">
                                ...
                                <div class="row form-group rowColorWhite">
                                    <div class="col-md-3">
                                        <label for="">48.-Asimilados a Salarios:</label><!--: Asimilados a Salarios Ingreso IAS-->
                                        <div class="input-group">
                                            <div class="input-group-addon info" title="Información del campo" info="Importe Neto a Pagar de Asimilados">
                                            <i class="fa fa-dollar"></i>
                                            </div>
                                    ...
                                    <div class="col-md-3">
                                        <label for="">49.-Anticipo a Rendimientos:</label><!--Ingresos sin timbrar-->
                                        <div class="input-group">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon info" title="">
                                            <i class="fa fa-dollar"></i>
                                            </div>
                                            <input class="form-control monetario iluminarIconoInput" type="text" name="sindicato">
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control monetario iluminarIconoInput" type="text" name="tarjeta_empresarial">
                                        </div>
                                    </div>
                                ...
                                <div class="row form-group rowColorGray">
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control monetario iluminarIconoInput" type="text" name="modalidad_40">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row form-group rowColorWhite">
                                    ...
                                    <div class="col-md-3">
                                        <label for="">62.-Comisión socio o cliente:</label><!-- Comisión cobrada al socio-->
                                        <div class="input-group">
                                ...
                                <div class="row form-group rowColorGray">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon info" title="Información del campo" info="Sumatoria de todos los campos de asimilados (48-67), únicamente para carácter comprobatorio" style="background:#00a65a!important;">
                                            <i class="fa fa-dollar"></i>
                                            </div>
                                            <input class="form-control monetario iluminarIconoInput" type="input" id="comprobacionAsimilados" disabled>
                                        </div>                              
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="alert alert-secondary" role="alert" style="margin-bottom:-30px;">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <span class="btn btn-primary btn-lg btn-file"><i class="fa fa-cloud-upload"></i> Cargar archivo <input type="file" name="excelnominas" id="excelnominas" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"></span> 
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 text-center">
                                                        <H3>ÚLTIMA ACTUALIZACIÓN 30-06-2020</H3>
                                                    </div>
                                                </div>
                                            </div>
...
<!-- -->
    ...
    <!-- -->
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="input-group">
                                    ...
                                    <select class="form-control textoMay iluminarIconoInput" id="filtroNombreCliente" >
                                        <option></option>
                                        <?php echo Nominas::mostrarSelect($datos["id_cliente"],Tablas::clientes(),true); ?>
                                    </select>
                                </div>   
                            </div>  
                        </div>
                            ...
                            <?php if($liberacion !== "active"): ?>
                                ...
                                <div class="row form-group" style="margin-bottom: -20px;">
                                    <div class="col-md-2">
                                        ...
                                        <form method="post">
                                            <div class="col-md-4" style="text-align:right;margin-top:15px;">
                                                <button type="submit" name="tablaLiberacionNuveaVersion" value="" class="btn btn-success btn-lg">Tabla liberación</button> 
                                            </div>   
                                        </form>
                                        <?php endif; ?>
                                    </div>  
                    ...
                    <?php if($_SESSION['identificador2'] == 6 || $_SESSION['identificador'] == 201 ): ?>
                        <div role="tabpanel" class="tab-pane" id="autorizacion"> 
                            ...
                            <div class="row renglon-encabezado mostrar768" style="margin:1px;">
                                ...
                                <div class="col-sm-4 columna-div columna-div-centrar">Puesto</div>
                            </div>
                    ...
                    <div role="tabpanel" class="tab-pane" id="configurar"> 
                        <?php
                         $data = array( 'cliente2'=>'',
                                        'status'=>$_SESSION['identificador']); 
                        $paginacion2 = new Paginacion(50);
                        $paginacion2->target('clientes-finanzas');
                        $paginacion2->parametroCliente($data['cliente2']);
                        $paginacion2->parametrosAutorizacion($data['status']);
                        $totalRegistros2=Nominas::contarRegistrosClientes();
                        $paginacion2->totalPaginas($totalRegistros2);
                        $registrosAsigandos = Nominas::registrosAsignados($_SESSION['identificador']);
                        $registrosAsigandos = $registrosAsigandos == 0 ? $totalRegistros2 : $registrosAsigandos;
                        ?>

                        <h5><i class="fa fa-exclamation-circle fa-2x" style="color:#FF4500;"></i> Selecciona los clientes que quieres vincular a la cuenta de un usuario (personal a tu cargo); los usuarios que no tengan vinculado ningún cliente por defecto se le mostraran todos los clientes.</h5>
                        <div class="row">
                            <div class="col-md-6">
                                <span><u>Total de clientes: </u><b id="totalClientes" style="font-size:24px;"><?php echo $totalRegistros2; ?></b></span>
                            </div>
                            <div class="col-md-6">
                                <span><u>Clientes asignados al usuario seleccionado: </u><b id="totalClientesAsignados" style="font-size:24px;"><?php echo $registrosAsigandos; ?></b></span>
                            </div>
                        </div> 
                        <hr>
                        <div class="row">
                            <div class="col-md-6">
                               <div class="input-group">
                                    <div class="input-group-addon" style="background:#0e7cb9;color:#fff;">
                                        <i class="fa fa-search" aria-hidden="true"></i>
                                    </div>
                                    <input class="form-control" type="text" placeholder="Buscar empresa por nombre..." id="buscadorClientes">
                                </div>  
                            </div>
                            <div class="col-md-6">
                                <div class="input-group">
                                    ...
                                    <select class="form-control" id="filtroVisualizacionCliente" >
                                        <option value="<?php echo $_SESSION['identificador'] ?>"><?php echo Nominas::getNominista(); ?></option>
                                        <?php echo Nominas::verificarJefatura2(); ?>
                                    </select>
                                </div>   
                            </div>
                        </div> 
                        ...
                        <br>
                        <span class="paginadorClientes"><?php echo $paginacion2->mostrar();?></span>
                        <div class="row renglon-encabezado mostrar768" style="margin:1px;">
                            <div class="col-sm-1 columna-div columna-div-centrar">No.</div>
                            <div class="col-sm-8 columna-div columna-div-centrar">Cliente</div>
                            <div class="col-sm-3 columna-div columna-div-centrar">Visualizar</div>
                        </div>
                       
                        <div id="dataClientes">
                            <?php echo Nominas::mostrarLista($paginacion2->limitRegistros(),$data);?>
                        </div>
                        <span class="paginadorClientes"><?php echo $paginacion2->mostrar();?></span>
                    </div>
