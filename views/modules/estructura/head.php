...
<audio src="<?php echo Ruta::ruta_server();?>views/sonidos/rebelde.mp3" preload="auto" id="customTicketChava"></audio>
        ...
        <?php endif ?>
                ...
                <ul class="menuNotificaciones">
                  ...
                  <li id="notificacionTickets">
                    <?php if( $miPerfil->tickets > 0): ?>
                      <form id="expandirPestanaTicketFormulario" action="tickets-soporte" method="post">
          ...
          <li class="dropdown user user-menu">
            ...
            <?php if($_SESSION["imagen"] != NULL): ?>
              <img src="<?php echo Ruta::ruta_server();?>views/imagenes-usuarios/mini/<?php echo $_SESSION["imagen"]; ?>" class="user-image" alt="User Image">
            <?php else: ?>
              <img src="<?php echo Ruta::ruta_server();?>views/img/user.png" class="user-image" alt="User Image">
            <?php endif ?>
              <span class="hidden-xs" id="codigoUnitario" name="<?php echo $_SESSION["identificador"];?>"><?php echo $_SESSION["usuario"];?></span>
            </a>
            <ul class="dropdown-menu">
