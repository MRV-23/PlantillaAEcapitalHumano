    ...
    <section class="sidebar">
     ...
     <!-- <form action="#" method="get" class="sidebar-form">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if(GrupoNominas::pertenece2($_SESSION['identificador']) || GrupoFinanzas::pertenece($_SESSION['identificador']) || GrupoTesoreria::pertenece($_SESSION['identificador']) || GrupoLiberacion::pertenece($_SESSION['identificador']) || GrupoEmpresas::pertenece($_SESSION['identificador']) || GrupoCostos::pertenece($_SESSION['identificador'])): ?>
        <li class="treeview <?php echo $controlOperaciones;?>">
          ...
          <?php if(GrupoNominas::pertenece2($_SESSION['identificador']) || GrupoFinanzas::pertenece($_SESSION['identificador']) || GrupoTesoreria::pertenece($_SESSION['identificador']) || GrupoLiberacion::pertenece($_SESSION['identificador']) || GrupoFacturacion::pertenece($_SESSION['identificador']) || GrupoConciliacion::pertenece($_SESSION['identificador'])): ?>
          ...
          <?php if(GrupoCostos::pertenece($_SESSION['identificador'])): ?>
          ...
          <?php if(GrupoConciliacion::pertenece($_SESSION['identificador'])): ?>
