...
$inicio=$agenda=$paqueteria=$solicitudes=$test=$rh=$sistemas=$giro=$tickets=$ticketsAdministrador=$eventos=$tutoriales=$empresas=$nominas=$finanzas=$tesoreria=$liberacion=$facturacion=$ayuda=$moduloTickets=$controlOperaciones=$proyectos='';
$paqueteNuevo=$paqueteAdministrar=$personal=$sucursales=$paginaInicio=$reportes=$nutrifitness=$inventario=$nutriRh=$cursos=$reconocimientos=$moduloNominas=$clientes=$permisos=$costos=$software=$conexiones=$conciliacion=$espera=$desarrollo=$prueba="";
...
switch($activar){
  ...
  case '/asesores/giro':
    $giro='active';
  break;
  case '/asesores/tickets-soporte':
    $tickets='active';
    $moduloTickets='active';
  break;
  case '/asesores/tickets-administrador':
  ...
  case '/asesores/clientes':
    ...
    $clientes='active';
  break;
  case '/asesores/permisos':
    $controlOperaciones='active';
    $proyectos='active';
    $espera='active';
    $permisos='active';
  break;
  case '/asesores/costos':
    $controlOperaciones='active';
    $proyectos='active';
    $prueba='active';
    $costos='active';
  ...
  case '/asesores/linea-ayuda':
    $ayuda='active';
  break;
  case '/asesores/software':
    $sistemas='active';
    $software='active';
  break;
  case '/asesores/conexiones':
    $sistemas='active';
    $conexiones='active';
  case '/asesores/test':
    $test='active';
